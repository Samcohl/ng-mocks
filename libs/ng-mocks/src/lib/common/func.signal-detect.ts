...
export const isInputSignal = (obj: any, prop: string): boolean => {
    ...
    return !!(value as any)[Symbol.for('ɵINPUT_SIGNAL_BRAND_WRITE_TYPE')] ||
        !!(value as any)['ɵINPUT_SIGNAL_BRAND_WRITE_TYPE'] ||
        // Fallback: check si c'est une fonction avec certaines propriétés de signal
        (typeof value === 'function' &&
            (value.toString().indexOf('inputSignal') !== -1 ||
                value.toString().indexOf('signal') !== -1));
};
...
export const isOutputSignal = (obj: any, prop: string): boolean => {
    ...
    return !!(value as any).emit && typeof (value as any).emit === 'function' &&
...
export const isModelSignal = (obj: any, prop: string): boolean => {
    ...
    return !!(value as any).set && typeof (value as any).set === 'function' &&
        !!(value as any).update && typeof (value as any).update === 'function' &&
...
export const isContentChildSignal = (obj: any, prop: string): boolean => {
    ...
    return !!(value as any)[Symbol.for('ɵCONTENT_CHILD_SIGNAL_BRAND')] ||
...
export const isContentChildrenSignal = (obj: any, prop: string): boolean => {
    ...
    return !!(value as any)[Symbol.for('ɵCONTENT_CHILDREN_SIGNAL_BRAND')] ||
